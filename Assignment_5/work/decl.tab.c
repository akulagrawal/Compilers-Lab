...
#line 389 "decl.tab.c" /* yacc.c:355  */
};
...
#line 406 "decl.tab.c" /* yacc.c:358  */
...
{
       0,   297,   297,   303,   304,   307,   317,   318,   322,   323,
     329,   336,   343,   354,   355,   369,   373,   380,   381
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LSB", "VAR_NAME", "NUM", "EQUAL", "OP", "$accept", "decl", "decl_list",
  "one_dec", "type", "name_list", "id_arr", "expr", "br_dimlist", "id", YY_NULLPTR
};
#endif
...
{
      -1,   -17,   -17,     9,     7,   -17,    -3,   -17,    -1,   -17,
     -17,   -17,     5,    -6,   -17,    -3,    -3,    -3,   -17,   -17,
       6,   -17,     0,     8,    -3,   -17,   -17
};
...
{
       0,     6,     7,     0,     0,     3,     0,     1,     2,    17,
      18,     5,     8,    10,     4,     0,     0,     0,    12,     9,
       0,    11,    13,    15,     0,    16,    14
};
...
{
     -17,   -17,   -17,    10,   -17,     2,   -17,   -10,    -8,   -16
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     3,     4,     5,     6,    11,    12,    21,    18,    13
};
...
{
      20,    22,    16,     1,     2,    17,     9,    10,    22,     7,
       8,    15,    24,    23,    26,    25,    16,    19,    14
};

static const yytype_uint8 yycheck[] =
{
      16,    17,     8,     4,     5,    11,     9,    10,    24,     0,
       3,     6,    12,     7,    24,    23,     8,    15,     8
};
...
{
       0,     4,     5,    14,    15,    16,    17,     0,     3,     9,
      10,    18,    19,    22,    16,     6,     8,    11,    21,    18,
      22,    20,    22,     7,    12,    21,    20
};
...
#line 1488 "decl.tab.c" /* yacc.c:1646  */
    break;
...
#line 307 "decl.y" /* yacc.c:1646  */
    {
								(yyval.c) = (yyvsp[-1].c);
								symtab.patch((yyvsp[-1].c), (yyvsp[0].sval));
								vector<string> dim = makedimlist((yyvsp[0].sval));
								checksanity(dim);
								// makecorrect(dim);
								cout<<endl;
							}
#line 1501 "decl.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 317 "decl.y" /* yacc.c:1646  */
    {(yyval.c) = 'i';}
#line 1507 "decl.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 318 "decl.y" /* yacc.c:1646  */
    {(yyval.c) = 'f';}
#line 1513 "decl.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 323 "decl.y" /* yacc.c:1646  */
    {
										(yyval.sval)=(yyvsp[-2].sval);
										strcat((yyval.sval),",");
										strcat((yyval.sval),(yyvsp[0].sval));
									}
#line 1523 "decl.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 329 "decl.y" /* yacc.c:1646  */
    {
										//abhishek //assignment quad = 0;
										variable v = variable((yyvsp[0].sval), "type", "0", false, dummy);
										if(symtab.search(v.name) == -1)
											symtab.insertintosymtab(v);
									}
#line 1534 "decl.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 336 "decl.y" /* yacc.c:1646  */
    {
										//abhishek //assignment quad = exprvalue;
										variable v = variable((yyvsp[-2].sval), "type", (yyvsp[0].sval), false, dummy);
										if(symtab.search(v.name) == -1)
											symtab.insertintosymtab(v);	
									}
#line 1545 "decl.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 343 "decl.y" /* yacc.c:1646  */
    {
										//abhishek //assignment quad = 0;
										//here seperate values should be assigned to seperate elements
										//not done as of now
										vector<string> dim = makedimlist((yyvsp[0].sval));
										variable v = variable((yyvsp[-1].sval), "type", "0", true, dim);
										if(symtab.search(v.name) == -1)
											symtab.insertintosymtab(v);
									}
...
#line 1575 "decl.tab.c" /* yacc.c:1646  */
    break;
...
#line 1583 "decl.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 373 "decl.y" /* yacc.c:1646  */
    {
										(yyval.sval)=(yyvsp[-2].sval);
										strcat((yyval.sval),",");
										strcat((yyval.sval),(yyvsp[0].sval));
...
#line 1597 "decl.tab.c" /* yacc.c:1646  */
      default: break;
    }
