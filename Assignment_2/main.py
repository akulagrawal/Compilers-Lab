...
def main(filename = 'input.txt'):
    ...
    sourceline_count, blankline_count = count_lines(filename)

    # remove comments from input.txt and write to intermediate.txt
    commentline_count = remove_comments(filename, intermediate_file)
    ...
    with open(out_file, 'w') as f:
    	f.write('Number of Non-Blank Lines in Source Code: ' + str(sourceline_count) + '\n')
    	f.write('Number of Blank Lines in Source Code: ' + str(blankline_count) + '\n')
    	f.write('Number of Comment Lines in Source Code: ' + str(commentline_count) + '\n')
